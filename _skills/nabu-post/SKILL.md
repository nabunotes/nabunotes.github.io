...
- Tags are in English, lowercase, hyphen-separated
...
3. Suggest tags based on the conversation content, preferring existing tags where possible
4. Ask the user for: structure preference, category, tag approval
5. Compose the post following the rules above
6. Show the user a full preview of the post before pushing
7. Wait for explicit user permission before pushing anything to the repo
8. Only after permission is given: push the markdown file and images to the repo via Cowork
